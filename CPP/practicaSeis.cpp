...
int main()
{
    ...
    */
    ...
    // Determinar la suma de los números que son múltiplos de 5 en un rango del 1 al 100
    cout << "\nPráctica #5\n";
    int sumaMultiplesCinco = 0;
    for (int i = 1; i <= 100; i++)
    {
        if (i % 5 == 0)
        {
            sumaMultiplesCinco += i;
        }
    }
    cout << "La suma de los números que son múltiples de 5 en un rango del 1 al 100 es: " << sumaMultiplesCinco;
